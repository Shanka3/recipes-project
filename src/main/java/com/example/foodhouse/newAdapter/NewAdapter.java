package com.example.foodhouse.newAdapter;
...
import com.example.foodhouse.activity.SkipDetailActivity;
import com.example.foodhouse.model.FoodData;

import java.util.ArrayList;
import java.util.List;

public class NewAdapter extends RecyclerView.Adapter<FoodViewHolder> {

    private Context mContext;
    private List<FoodData> myFoodList;
    private int lastPosition = -1;

    public NewAdapter(Context mContext, List<FoodData> myFoodList) {
    ...
    public FoodViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View mView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_veg_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final FoodViewHolder foodViewHolder, int i) {
        ...
        foodViewHolder.mComments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, SkipDetailActivity.class);
